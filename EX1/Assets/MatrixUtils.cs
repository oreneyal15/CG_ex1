...
public static class MatrixUtils
{
    ...
    // Converts a given rotation quaternion q to an equivalent rotation matrix 
    public static Matrix4x4 RotateFromQuaternion(Vector4 q)
    {
        Quaternion q0 = new Quaternion(q.x, q.y, q.z, q.w);
        return Matrix4x4.TRS(Vector3.zero, q0, Vector3.one);
    }
}